...
<div class="container-fluid px-0">
    ...
    <div class="d-flex justify-content-between align-items-start mb-4">
        <div>
            ...
            <p class="text-muted mb-0" style="font-size: 0.9rem;">Kelola katalog hama dan penyakit tanaman untuk referensi sistem AI.</p>
        </div>
                ...
                <table class="table align-middle mb-0" style="border-collapse: separate; border-spacing: 0;">
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom: 1px solid #f5f5f5;">
                            <td class="px-4 py-3">
                                <img src="{{ asset('images/hawar-daun.jpg') }}"
                                    alt="Hawar Daun Bakteri"
                                    class="rounded-3 object-fit-cover"
                                    style="width: 60px; height: 60px; background: #e0e0e0;"
                                    onerror="this.style.background='#d1e7dd'; this.removeAttribute('src');">
                            </td>
                            <td class="px-3 py-3">
                                <span class="fw-semibold" style="color: #1a1a1a; font-size: 0.95rem;">Hawar Daun Bakteri</span>
                            </td>
                            <td class="px-3 py-3">
                                <span class="fst-italic text-muted" style="font-size: 0.875rem;">Xanthomonas oryzae</span>
                            </td>
                            <td class="px-3 py-3">
                                <span class="badge bg-light text-dark border me-1 fw-normal px-2 py-1 rounded-2" style="font-size: 0.78rem;">PADI</span>
                            </td>
                            <td class="px-3 py-3">
                            ...
                            <td class="px-4 py-3">
                                <div class="d-flex gap-2">
                                    <button class="btn btn-sm btn-outline-success rounded-3" style="font-size: 0.8rem;">Detail</button>
                                    <button class="btn btn-sm btn-outline-primary rounded-3" style="font-size: 0.8rem;">Edit</button>
                                    <button class="btn btn-sm btn-outline-danger rounded-3" style="font-size: 0.8rem;">Hapus</button>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr style="border-bottom: 1px solid #f5f5f5;">
                            <td class="px-4 py-3">
                                <img src="{{ asset('images/ulat-grayak.jpg') }}"
                                    alt="Ulat Grayak"
                                    class="rounded-3 object-fit-cover"
                                    style="width: 60px; height: 60px; background: #e0e0e0;"
                                    onerror="this.style.background='#d1e7dd'; this.removeAttribute('src');">
                            ...
                            <td class="px-3 py-3">
                                <span class="fst-italic text-muted" style="font-size: 0.875rem;">Spodoptera litura</span>
                            </td>
                            <td class="px-3 py-3">
                                <span class="badge bg-light text-dark border me-1 fw-normal px-2 py-1 rounded-2" style="font-size: 0.78rem;">JAGUNG</span>
                                <span class="badge bg-light text-dark border fw-normal px-2 py-1 rounded-2" style="font-size: 0.78rem;">KEDELAI</span>
                            </td>
                            <td class="px-3 py-3">
                                <span class="badge rounded-pill px-3 py-2 fw-semibold"
                        ...
                        <tr style="border-bottom: 1px solid #f5f5f5;">
                            <td class="px-4 py-3">
                                <img src="{{ asset('images/wereng-cokelat.jpg') }}"
                                    alt="Wereng Cokelat"
                                    class="rounded-3 object-fit-cover"
                                    style="width: 60px; height: 60px; background: #e0e0e0;"
                                    onerror="this.style.background='#d1e7dd'; this.removeAttribute('src');">
                            ...
                            <td class="px-3 py-3">
                                <span class="fw-semibold" style="color: #1a1a1a; font-size: 0.95rem;">Wereng Cokelat</span>
                            </td>
                            <td class="px-3 py-3">
                                <span class="fst-italic text-muted" style="font-size: 0.875rem;">Nilaparvata lugens</span>
                            </td>
                            <td class="px-3 py-3">
                                <span class="badge bg-light text-dark border me-1 fw-normal px-2 py-1 rounded-2" style="font-size: 0.78rem;">PADI</span>
                            </td>
                        ...
                        <tr style="border-bottom: 1px solid #f5f5f5;">
                            <td class="px-4 py-3">
                                <img src="{{ asset('images/antraknosa.jpg') }}"
                                    alt="Antraknosa"
                                    class="rounded-3 object-fit-cover"
                                    style="width: 60px; height: 60px; background: #e0e0e0;"
                                    onerror="this.style.background='#d1e7dd'; this.removeAttribute('src');">
                            ...
                            <td class="px-3 py-3">
                                <span class="fst-italic text-muted" style="font-size: 0.875rem;">Colletotrichum spp.</span>
                            </td>
                            <td class="px-3 py-3">
                                <span class="badge bg-light text-dark border me-1 fw-normal px-2 py-1 rounded-2" style="font-size: 0.78rem;">CABAI</span>
                                <span class="badge bg-light text-dark border fw-normal px-2 py-1 rounded-2" style="font-size: 0.78rem;">TOMAT</span>
                            </td>
                            <td class="px-3 py-3">
                                <span class="badge rounded-pill px-3 py-2 fw-semibold"
                                    style="background-color: #e8f5e9; color: #388e3c; font-size: 0.78rem; letter-spacing: 0.03em;">SEDANG</span>
                        ...
                        <tr>
                            <td class="px-4 py-3">
                                <img src="{{ asset('images/bulai-jagung.jpg') }}"
                                    alt="Bulai Jagung"
                                    class="rounded-3 object-fit-cover"
                                    style="width: 60px; height: 60px; background: #e0e0e0;"
                                    onerror="this.style.background='#d1e7dd'; this.removeAttribute('src');">
                            ...
                            <td class="px-3 py-3">
                                <span class="fw-semibold" style="color: #1a1a1a; font-size: 0.95rem;">Bulai Jagung</span>
                            </td>
                            <td class="px-3 py-3">
                                <span class="fst-italic text-muted" style="font-size: 0.875rem;">Peronosclerospora maydis</span>
                            </td>
                            <td class="px-3 py-3">
                                <span class="badge bg-light text-dark border me-1 fw-normal px-2 py-1 rounded-2" style="font-size: 0.78rem;">JAGUNG</span>
                            </td>
            ...
            <div class="d-flex justify-content-between align-items-center px-4 py-3"
                ...
                <nav>
                    <ul class="pagination pagination-sm mb-0 gap-1">
                        ...
                        <li class="page-item">
                            <button class="page-link rounded-3 border-0 text-muted" style="font-size: 0.875rem;">2</button>
                        </li>
                        <li class="page-item">
                            <button class="page-link rounded-3 border-0 text-muted" style="font-size: 0.875rem;">
        ...
        <div class="modal-content rounded-4 border-0 shadow">
            ...
            <div class="modal-body px-4 pt-3 pb-2">
                <div class="row g-3">
                    ...
                    <div class="col-md-12">
                        <label class="form-label fw-semibold" style="font-size: 0.875rem;">Rekomendasi Penanganan</label>
                        <textarea class="form-control rounded-3" rows="2"
                            placeholder="Contoh: Fungisida tembaga, sanitasi lahan, varietas tahan"></textarea>
                    </div>
                    <div class="col-md-12">
                        <label class="form-label fw-semibold" style="font-size: 0.875rem;">Thumbnail Penyakit</label>
            ...
            <div class="modal-footer border-0 px-4 pb-4 pt-2">
                ...
                <button type="button" class="btn btn-success rounded-3 px-4 fw-semibold"
