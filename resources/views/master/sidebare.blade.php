<div class="sidebar-wrapper d-flex flex-column" style="height: 100vh; padding: 20px; background-color: #ffffff; border-right: 1px solid #e5e7eb;">
    
    <div class="sidebar-header mb-1"> <h3 style="display: flex; align-items: center; gap: 8px; color: #000000; margin: 0; font-weight: 700;">
    ...
    <div class="menu-label" style="color: #94a3b8; font-size: 14px; margin: 10px 0 12px 0; letter-spacing: 1.2px; font-weight: 800; text-transform: uppercase;">
        MENU UTAMA
    </div>
        ...
        <li class="nav-item w-100">
            <a href="{{ route('admin.dashboard') }}" 
               ...
               style="display: flex; align-items: center; gap: 10px; text-decoration: none; padding: 12px 15px; border-radius: 10px; transition: 0.3s;
                ...
                <i class="bi bi-grid-1x2-fill" style="{{ Request::routeIs('admin.dashboard') ? 'color: #16a34a;' : 'color: #16a34a;' }}"></i>
        ...
        <li class="nav-item w-100">
            <a href="{{ route('admin.manajemen-penyakit') }}" 
               ...
               style="display: flex; align-items: center; gap: 10px; text-decoration: none; padding: 12px 15px; border-radius: 10px; transition: 0.3s;
                ...
                <i class="bi bi-file-medical-fill" style="{{ Request::routeIs('admin.manajemen-penyakit') ? 'color: #16a34a;' : 'color: #64748b;' }}"></i>
